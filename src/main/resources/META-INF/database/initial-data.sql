...
insert into payment (order_id, status, card_number, dtype) values (1, 'PROCESSING', '123', 'CreditCardPayment');
insert into payment (order_id, status, bar_code, dtype) values (2, 'PROCESSING', '123', 'BankSlipPayment');
